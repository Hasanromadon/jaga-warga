...
Jaga Warga
  ...
  <p className="text-sm text-blue-700 text-center mb-2">Masuk ke dashboard admin Jaga Warga untuk mengelola data tagihan dan verifikasi pembayaran.</p>
      </div>
      ...
      <div className="w-full max-w-sm mt-8 flex items-center gap-3 bg-green-50 border border-green-100 rounded-lg p-3">
        ...
        <span className="text-sm text-green-900">Akses hanya untuk admin terdaftar. Data dijaga aman.</span>
      </div>
