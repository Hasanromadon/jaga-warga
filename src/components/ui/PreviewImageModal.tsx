...
export function PreviewImageModal({ open, src, onClose, title }: PreviewImageModalProps) {
    ...
    <Dialog open={open} onOpenChange={v => { if (!v) onClose(); }}>
      <DialogContent className="max-w-md p-4 flex flex-col items-center">
        <div className="w-full flex flex-col items-center">
          <div className="font-semibold text-base mb-2 text-blue-900">{title || "Preview Bukti Pembayaran"}</div>
